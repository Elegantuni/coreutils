...
static bool printing_name = false;
...
static struct option const longopts[] =
{
  ...
  {"printing_name", no_argument, NULL, 'p'},
...
"));
      oputs (_("\
  -p, --printing_name      print the name of the file at the beginning of the output\n\
"));
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, "brps:", longopts, NULL)) != -1)
    {
      switch (optc)
        {
        case 'b':
